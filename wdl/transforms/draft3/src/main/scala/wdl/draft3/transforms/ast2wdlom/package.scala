...
package object ast2wdlom {
  ...
  // meta sections
  implicit val astNodeToMetaValueElement: CheckedAtoB[AstNode, MetaValueElement] = CheckedAtoB.fromErrorOr(AstNodeToMetaValueElement.convert _)
  implicit val astNodeToMetaKvPair: CheckedAtoB[AstNode, MetaKvPair] = CheckedAtoB.fromErrorOr(AstNodeToMetaKvPair.convert _)
