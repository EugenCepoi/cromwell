...
object AstNodeToMetaKvPair {
  def astNodeToMetaKvPair(implicit astNodeToMetaValueElement: CheckedAtoB[GenericAstNode, MetaValueElement]): CheckedAtoB[GenericAstNode, MetaKvPair] = CheckedAtoB.fromErrorOr("convert AstNodeToMetaKvPair") {
